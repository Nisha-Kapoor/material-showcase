...
class WorkflowModel(application: Application) : AndroidViewModel(application) {
    ...
    fun onSearchCompleted(detectedObject: DetectedObjectInfo, recommendationList: List<String>) {
        ...
        searchedObject.value = SearchedObject(context.resources, lConfirmedObject, recommendationList)
    }
}
